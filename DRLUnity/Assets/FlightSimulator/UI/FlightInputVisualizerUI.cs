...
public class FlightInputVisualizerUI : MonoBehaviour
{
    ...
    void CallbackOnActionChange(float[] actions)
    {
        ...
        controlState.anchoredPosition = 100 * new Vector3(AS.rotatorAileronLeft.smoothAngle / AS.rotatorAileronLeft.magnitude, AS.rotatorElevator.smoothAngle / AS.rotatorElevator.magnitude, 0);
